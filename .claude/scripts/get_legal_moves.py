...
Usage:
    python .claude/scripts/get_legal_moves.py white
    python .claude/scripts/get_legal_moves.py black

Output: JSON list of move objects with from_sq, to_sq,11 move_str, piece, capture
"""
...
if __name__ == "__main__":
    if len(sys.argv) < 2 or sys.argv[1] not in ("white", "black"):
        print("Usage: python .claude/scripts/get_legal_moves.py <white|black>")
        sys.exit(1)
